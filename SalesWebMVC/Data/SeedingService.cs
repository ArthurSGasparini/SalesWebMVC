...
{
    public class SeedingService // Classe responsável por popular o banco de dados com dados iniciais, útil para testes e desenvolvimento
    {
        private SalesWebMVCContext _context; // Propriedade para acessar o contexto do banco de dados, permitindo operações de consulta e manipulação de dados

        public SeedingService(SalesWebMVCContext context) // Construtor para injetar o contexto do banco de dados, garantindo que a classe tenha acesso ao banco de dados para realizar as operações de seeding
        {
            _context = context; // Atribuição do contexto do banco de dados à propriedade da classe
        }

        public void Seed() // Método para realizar o processo de seeding, verificando se os dados já existem e, caso contrário, criando e adicionando os dados iniciais ao banco de dados
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) // Verificação para evitar a duplicação de dados, verificando se já existem registros nas tabelas de departamentos, vendedores ou vendas
            {
                return; // Se os dados já existirem, o método é encerrado sem realizar o seeding
            }
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // Adiciona os departamentos criados ao contexto do banco de dados
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); // Adiciona os vendedores criados ao contexto do banco de dados
            _context.SalesRecord.AddRange( // Adiciona os registros de vendas criados ao contexto do banco de dados
                r1, r2, r3, r4, r5, r6, r7, r8, r9, r10,
                r11, r12, r13, r14, r15, r16, r17, r18, r19, r20,
                r21, r22, r23, r24, r25, r26, r27, r28, r29, r30
            );

            _context.SaveChanges(); // Salva as alterações no banco de dados, persistindo os dados adicionados
